...
def crear_controles_3d():
    # Devuelve la barra de controles del Modo 3D como tarjeta horizontal.
    return html.Div(
        [
            ...
            _campo(
                "Pieza",
                dbc.Switch(id="switch-oculto-3d", label="Oculta en la caja", value=False),
            ),
            ...
            _campo(
                ...
                html.Div(
                    [
                        dbc.Button("Revelar", id="btn-revelar-3d", color="secondary"),
